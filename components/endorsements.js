    ...
    return (
        <section className={styles.endorsements}>
            <div className='wrapper'>
                ...
                > */}
                                <img
                                    src='/c-formosa-corp.png'
                                    alt='Formosa Plastics Corp'
                                />
                                {/* </a> */}
                                {/* <a
                ...
                > */}
                                ...
                                {/* </a> */}
                                <img src='/c-locagreen.svg' alt='Locagreen' />
                            </div>
                        </div>
                    </div>
                </div>
