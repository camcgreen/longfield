        ...
        <>
            ...
            <main className={styles.team}>
                <div className='wrapper'>
                    <h1>
                        {lang === 'english' ? 'Our team' : 'Nuestro equipo'}
                    </h1>
                        ...
                        <div className={styles.row2}>
                            <div className={styles.profile}>
                                <div className={styles.image}>
                                    <img
                                        src='/neil.jpg'
                                        alt='Neil Croft - Head of Operations'
                                    />
                                    <div className={styles.overlay}>
                                        <a
                        ...
                        <div className={styles.supplementary}>
                            <div className={styles.suppProfile}>
                                <div className={styles.image}>
                                    <img
                                        src='/tim.jpg'
                                        alt='Tim Hughes - Credit Controller'
                                    />
                                    <div className={styles.overlay}>
                                        <a
                    ...
                    /> */}
                            ...
                            <div className={styles.suppProfile}>
                                <div className={styles.image}>
                                    <img
                                        src='/eleni.jpg'
                                        alt='Eleni Devaney - Logistics Controller'
                                    />
                                    <div className={styles.overlay}>
                                        <a
                                            href='mailto:eleni@longchem.co.uk'
                                            target='_blank'
                                            rel='noopener noreferrer'
                                            style={{ marginBottom: 0 }}
                                        >
                                            eleni@longchem.co.uk
                                        </a>
                                    </div>
                                </div>
                                <h2>Eleni Devaney</h2>
